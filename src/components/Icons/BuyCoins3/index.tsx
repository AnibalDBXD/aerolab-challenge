...
const BuyCoins3: React.FC<IICon> = ({ size, height = "32px", width = "32px", style }: IICon): JSX.Element => (
    <svg height={size || height} style={style} viewBox="193.028 224.783 51.058 46.077" width={size || width} xmlns="http://www.w3.org/2000/svg">
        <defs>
        ...
        <g fill="none" fillRule="evenodd" id="g-7" stroke="none" strokeWidth="1" transform="matrix(1, 0, 0, 1, 202.93277, 223.480713)">
